...
if (!project.value) {
  throw createError({
    statusCode: 404,
    statusMessage:
      locale.value === "fr" ? "Projet introuvable" : "Project not found",
  });
}
...
<template>
  <div class="min-h-screen py-12" v-if="project">
    <div class="container mx-auto px-4 max-w-6xl">
      ...
      <div class="mb-16">
        <div
          class="relative w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-gray-200 dark:border-gray-700"
        >
      ...
      <section class="mb-16">
        <h2
          class="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3"
        >
      ...
      >
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <div
            ...
            :class="[
              'space-y-3',
              index === project.screenshots.length - 1 &&
          ...
          >
            <div
              class="rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow aspect-video"
            >
              <NuxtImg
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          >
            <div class="flex items-start gap-4">
              <div
                class="flex-shrink-0 w-10 h-10 bg-blue-500 dark:bg-green-500 rounded-lg flex items-center justify-center"
              >
      ...
      <section v-if="project.otherInfo" class="mb-16">
        ...
        >
          ...
          <div
            class="grid md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-700"
          >
            <div v-if="project.otherInfo.year" class="p-6 text-center">
              <div class="text-2xl font-bold text-blue-500 mb-2">
                {{ project.otherInfo.year }}
              </div>
          ...
          <div
            v-if="
              project.otherInfo.challenges &&
              project.otherInfo.challenges.length > 0
            "
            class="p-6 border-t border-gray-200 dark:border-gray-700"
          >
            <h3
              class="font-semibold text-lg text-gray-900 dark:text-white mb-4 flex items-center gap-2"
            >
              {{
            ...
            <ul class="space-y-2">
              ...
              >
                <UIcon
                  ...
                  class="text-orange-500 flex-shrink-0 mt-1"
                />
                <span>{{ challenge }}</span>
              </li>
            </ul>
          ...
          <div
            v-if="
              project.otherInfo.results && project.otherInfo.results.length > 0
            "
            class="p-6 border-t border-gray-200 dark:border-gray-700"
          >
            <h3
      ...
      <!-- ==================== CTA FINAL ==================== -->
      <section
        class="mt-16 p-8 bg-gradient-to-r bg-gray-800 dark:bg-gray-800 rounded-2xl text-center text-white"
      >
